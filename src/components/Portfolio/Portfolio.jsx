  ...
  return (
    <>
      <div id="portfolio" className="px-5 lg:px-10">
        <motion.div
          className="bg-darkBg rounded-2xl overflow-hidden py-20"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={fadeIn}
        >
          <div className="container mx-auto max-w-[1320px] px-5">
            <motion.div
              className="md:w-4/5 lg:w-3/4 md:mx-auto"
              variants={fadeIn}
            >
              ...
              >
                {AllProjects.map((res) => (
                  <SwiperSlide key={res.id}>
                    <motion.div
                      className="group/portfolio-box group"
                      variants={fadeIn}
                    >
                      <div className="overflow-hidden relative rounded-2xl">
                        <div className="absolute w-full h-0 overflow-hidden opacity-0 group-hover:opacity-100 group-hover:w-full group-hover:h-full  rounded-[16px] bottom-0 left-1/2 z-10  group-hover:bg-black/50 bg-blend-soft-light  group-hover:backdrop-blur-[10px] transition-all duration-[0.5s]  -translate-x-1/2">
                          <div className="p-2">
                            <p className="text-white text-[12px] sm:text-sm xl:text-md  font-normal tracking-wider">
                              {res.description}
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="pt-6">
                        <motion.ul
                          className="text-white font-outfit font-medium uppercase text-sm tracking-wider"
                          variants={fadeIn}
                        >
